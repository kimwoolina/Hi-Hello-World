...
@Component("filedownqa")
public class QaDownloadView extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, 
		...
		System.out.println("filedownqa : " + originalFilename);
		System.out.println("filedownqa : " + renameFile.getName());
