	...
	jQuery(document)
			.on(
					...
					function() {
						...
						$(window)
								.on(
										...
										function() {
											...
											var pagePreloaderId = document
													.getElementById("page-preloader");
											setTimeout(function() {
						...
						$(window).on(
								...
								function() {
									if ($(this).scrollTop() > 200) {
										$('.mainmenu-area').addClass(
												'menu-animation');
										$('.topcontrol').addClass(
												'topanimation');
									} else {
										$('.mainmenu-area').removeClass(
												'menu-animation');
										$('.topcontrol').removeClass(
												'topanimation');
									}
								});

						$('a.js-scroll-trigger').on(
								'click',
								function(e) {
									var anchor = $(this);
						...
						$(".home-slides,.home-slides-2")
								.on(
										"translate.owl.carousel",
										function() {
											$(this)
													.find(
															".owl-item .home-single-slide h2")
													.removeClass(
															"fadeInLeft animated")
													.css("opacity", "0");
											$(this)
													.find(
															".owl-item .home-single-slide p")
													.removeClass(
															"fadeInRight animated")
													.css("opacity", "0");
											$(this)
													.find(
															".owl-item .home-single-slide .home-single-slide-button a")
													.removeClass(
															"fadeInUp animated")
													.css("opacity", "0");
										});
						...
						$(".accordion-box").on(
								...
								'.acc-btn',
								function() {
									var outerBox = $(this).parents(
											'.accordion-box');
									var target = $(this).parents('.accordion');
									if ($(this).hasClass('active') !== true) {
										$('.accordion .acc-btn').removeClass(
												'active');
									}
									if ($(this).next('.acc-content').is(
										...
										$(outerBox).children('.accordion')
												.removeClass('active-block');
										$(outerBox).find('.accordion')
						...
						$('.counter-section')
								.on(
										'inview',
										function(event, visible, visiblePartX,
												visiblePartY) {
											if (visible) {
												$(this)
														.find('.timer')
